...
public class RestHelper {
     ...
     * <strong>주의</strong>: 이 메서드는 HTTP 상태 코드와 메세지를 파라미터로 받아
     * JSON 형식으로 에러 메세지를 리턴한다.
     * @param status - HTTP 상태 메서드
     * @param message - 결과 메세지
     * @return Map&lt:String, Object&gt;
     */
    ...
    /**
    * JSON 형식으로 에러 메세지를 리턴한다.
    * HTTP 상태코드는 400으로 설정하고, 결과 메세지는 파라미터로 전달되는 값을 설정한다.
    *파라미터 유효성 검사 실패 등의 경우에 사용한다.
    ...
    /**
    * JSON 형식으로 에러 메세지를 리턴한다.
    * HTTP 상태코드는 400으로 설정하고, 결과 메세지는 파라미터로 전달되는 error 객체를 사용한다.
    *파라미터 유효성 검사 실패 등의 경우에 사용한다.
    * @param error - 에러 객체
    * @return Map
    */
    ...
    /**
    * JSON 형식으로 에러 메세지를 리턴한다.
    * HTTP 상태코드는 500으로 설정하고, 결과 메세지는 파라미터로 전달되는 값을 설정한다.
    ...
    */
    ...
    /**
    * JSON 형식으로 에러 메세지를 리턴한다.
    * HTTP 상태코드는 500으로 설정하고, 결과 메세지는 파라미터로 전달되는 error 객체를 사용한다.
    *400 에러 이외의 모든 경우에 사용한다. 주로 DB연동 등의 처리에서 발생한 에러를 처리한다.
    *
    * @param error - 에러 객체
    * @return Map
